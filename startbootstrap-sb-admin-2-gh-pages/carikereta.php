...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["stasiun_keberangkatan"]) && isset($_POST["stasiun_kedatangan"]) && isset($_POST["date"])&& isset($_POST["class"])) {
        ...
        WHERE j.stasiun_keberangkatan = '$stasiun_keberangkatan' 
        AND j.stasiun_kedatangan = '$stasiun_kedatangan' 
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<div class='route'> " . $stasiun_keberangkatan . " <img src='img/route.svg'> " . $stasiun_kedatangan . "</div><br><br>";
...
$durasi_formatted = $jam . 'j ' . $menit . 'm';
    ...
    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_keberangkatan) . "</span><br><span class='terminal-keberangkatan'>" . $row["stasiun_keberangkatan"] . "</span></td>";


    echo "<td class='durasi'>" . $durasi_formatted . "</td>";

    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_kedatangan) . "</span><br><span class='terminal-keberangkatan'>" . $row["stasiun_kedatangan"] . "</span></td>";
    ...
    echo "<td><span> Rp." . $harga . " /Tiket</span><br><br><a href='detailbooktiketkereta.php?id=" . $row['id_jadwaltiketkereta'] . "' class='button-beli'>Booking</a></td>";
