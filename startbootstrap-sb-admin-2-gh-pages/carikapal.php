...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["pelabuhan_keberangkatan"]) && isset($_POST["pelabuhan_kedatangan"]) && isset($_POST["date"])&& isset($_POST["class"])) {
        ...
        WHERE j.pelabuhan_keberangkatan = '$pelabuhan_keberangkatan' 
        AND j.pelabuhan_kedatangan = '$pelabuhan_kedatangan' 
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<div class='route'> " . $pelabuhan_keberangkatan . " <img src='img/route.svg'> " . $pelabuhan_kedatangan . "</div><br><br>";
...
$durasi_formatted = $jam . 'j ' . $menit . 'm';
    ...
    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_keberangkatan) . "</span><br><span class='terminal-keberangkatan'>" . $row["pelabuhan_keberangkatan"] . "</span></td>";


    echo "<td class='durasi'>" . $durasi_formatted . "</td>";

    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_kedatangan) . "</span><br><span class='terminal-keberangkatan'>" . $row["pelabuhan_kedatangan"] . "</span></td>";
