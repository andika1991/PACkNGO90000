...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tambah Jadwal Tiket Kereta</h1>
<p class="mb-4">Isi formulir di bawah ini untuk menambahkan Jadwal Tiket Kereta.</p>

<!-- Form Tambah Jadwal Pesawat -->
<form method="POST" action="prosestambahjadwalkereta.php">
