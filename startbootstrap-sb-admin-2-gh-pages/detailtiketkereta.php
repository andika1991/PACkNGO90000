    ...
    <div class="container">
        <div class="row">
            ...
            if(isset($_GET['id'])) {
                ...
                $query = "SELECT 
                            pb.invoice_id, 
                            jtb.stasiun_keberangkatan, 
                            jtb.stasiun_kedatangan, 
                            jtb.kelas, 
                            vb.nama_vendor, 
                            mp.nama_metode, 
                            pb.bukti_bayar, 
                        ...
                        FROM 
                            pesanantiketkereta pb 
                        JOIN 
                            jadwal_tiket_kereta jtb ON pb.id_jadwaltiketkereta = jtb.id_jadwaltiketkereta
                        JOIN 
                            vendor_kereta vb ON jtb.id_vendorkrta = vb.id_vendorkrta
                        JOIN 
                            metodepembayaran mp ON pb.id_metode = mp.id_metode 
                        JOIN 
                            pengguna uo ON pb.id_pengguna = uo.id_pengguna
                        JOIN
                            datapenumpangkereta dpb ON pb.id_datapenumpang = dpb.id_datapenumpang
                        WHERE
                            pb.id_pesanantiket = $id_pesanantiketkapal";
                       ...
                       <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Terminal Keberangkatan:</strong> <?php echo $row["stasiun_keberangkatan"]; ?></p>
                                <p class="card-text"><strong>Terminal Kedatangan:</strong> <?php echo $row["stasiun_kedatangan"]; ?></p>
