...
<section class="contaifoner">
    ...
    <form id="checkout-form" action="proses_pengisian_datakereta.php" method="POST">
       
        <input type="hidden" id="id_jadwaltiketkereta" name="id_jadwaltiketkereta" value="<?php echo $_GET['id']; ?>">
