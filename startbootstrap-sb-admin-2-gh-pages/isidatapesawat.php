...
<section class="contaifoner">
    ...
    <form id="checkout-form" action="proses_pengisian_datapesawat.php" method="POST">
       
        <input type="hidden" id="id_jadwaltiketpesawat" name="id_jadwaltiketpesawat" value="<?php echo $_GET['id']; ?>">
