        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   $totalPenjualanBus = 0;
                   $totalPenjualanKapal = 0;
                   $totalPenjualanKereta = 0;
                   $totalPenjualanPesawat = 0;
                   ...
                   if ($resultBus->num_rows > 0) {
                       ...
                       $totalPenjualanBus = $rowBus['total_penjualan'];
                   }
                   ...
                   if ($resultKapal->num_rows > 0) {
                       $rowKapal = $resultKapal->fetch_assoc();
                       $totalPenjualanKapal = $rowKapal['total_penjualan'];
                   }
                   ...
                   if ($resultKereta->num_rows > 0) {
                       $rowKereta = $resultKereta->fetch_assoc();
                       $totalPenjualanKereta = $rowKereta['total_penjualan'];
                   }
                   
                   // Query untuk menghitung total penjualan tiket pesawat
                   ...
                   if ($resultPesawat->num_rows > 0) {
                       $rowPesawat = $resultPesawat->fetch_assoc();
                       $totalPenjualanPesawat = $rowPesawat['total_penjualan'];
                   }
