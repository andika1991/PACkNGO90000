...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["bandara_keberangkatan"]) && isset($_POST["bandara_kedatangan"]) && isset($_POST["date"])&& isset($_POST["class"])) {
        ...
        WHERE j.bandara_keberangkatan = '$bandara_keberangkatan' 
        AND j.bandara_kedatangan = '$bandara_kedatangan' 
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<div class='route'> " . $bandara_keberangkatan . " <img src='img/route.svg'> " . $bandara_kedatangan . "</div><br><br>";
...
$durasi_formatted = $jam . 'j ' . $menit . 'm';
    ...
    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_keberangkatan) . "</span><br><span class='terminal-keberangkatan'>" . $row["bandara_keberangkatan"] . "</span></td>";


    echo "<td class='durasi'>" . $durasi_formatted . "</td>";

    echo "<td><span class='waktu-keberangkatan'>" . date("H:i", $waktu_kedatangan) . "</span><br><span class='terminal-keberangkatan'>" . $row["bandara_kedatangan"] . "</span></td>";
    ...
    echo "<td><span> Rp." . $harga . " /Tiket</span><br><br><a href='detailbooktiketpesawat.php?id=" . $row['id_jadwaltiketpesawat'] . "' class='button-beli'>Booking</a></td>";
