...
if (isset($_GET['invoice_id'])) {
    ...
    if ($stmt = $conn->prepare($query_select)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $pdf->SetSubject('Kapal E-Ticket');
            $pdf->SetKeywords('TCPDF, PDF, ticket, kapal, e-ticket');
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $html .= '<p>Keberangkatan: ' . $row['pelabuhan_keberangkatan'] . ' - ' . date('d/m/Y H:i', strtotime($row['waktu_keberangkatan'])) . '</p>';
                $html .= '<p>Kedatangan: ' . $row['pelabuhan_kedatangan'] . ' - ' . date('d/m/Y H:i', strtotime($row['waktu_kedatangan'])) . '</p>';
                $html .= '</div>';
                ...
                $html .= '<tr><th>Nomor Kendaraan</th><td>' . $row['nomor_kendaraan'] . '</td></tr>';
                $html .= '<tr><th>Golongan</th><td>' . $row['kelas'] . '</td></tr>';
