...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM jadwal_tiket_pesawat WHERE id_jadwaltiketpesawat = $id";
    ...
    if(mysqli_num_rows($result) == 1) {
        ...
        $id_jadwaltiketpesawat = $row['id_jadwaltiketpesawat'];
        $waktu_keberangkatan = $row['waktu_keberangkatan'];
        $waktu_kedatangan = $row['waktu_kedatangan'];
        $bandara_keberangkatan = $row['bandara_keberangkatan'];
        $bandara_kedatangan = $row['bandara_kedatangan'];
        $harga = $row['harga'];
        $kelas = $row['kelas'];
...
<form method="POST" action="proseseditjadwalpesawat.php">
<input type="hidden" name="id_jadwaltiketpesawat" value="<?php echo $id_jadwaltiketpesawat; ?>">
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="bandara_keberangkatan" name="bandara_keberangkatan" value="<?php echo $bandara_keberangkatan; ?>" required>
