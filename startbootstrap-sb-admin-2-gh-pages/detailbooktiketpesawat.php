...
if(isset($_GET['id'])) {
    ...
    if(mysqli_num_rows($result) > 0) {
       ...
       echo "<p style='font-size: 16px; color: #333;margin-left:50px; font-weight: 600; margin-bottom: 15px;margin-top:-10px;'>Alamat Maskapai: " . $row['alamat_vendor'] . "</p>";
...
echo "<div style='font-size: 24px; color: #DC3545; margin-left: 40px; margin-top: -5px;'> Nomor Penerbangan: " . $row['nomor_penerbangan'] . "</div>"; 
...
echo "</div>";
            ...
            echo "<a href='isidatapesawat.php?id=" . $row['id_jadwaltiketpesawat'] . "' class='button-beli' ><img src='img/isidata.svg'>Lanjut Pengisian Data</a>";
