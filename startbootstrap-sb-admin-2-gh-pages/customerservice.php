...
.cs {
    ...
    border-radius: 5px;
    padding: 10px 20px;
    display: inline-block; /* Ini memastikan elemen hanya sebesar konten di dalamnya */
}
...
<img style="padding-left:30px;padding-top:50px;"src="img/image 40.svg">

<div class="butuhbantuan">
    <h5 style="font-weight:bold;">Butuh Bantuan dan pertanyaan?</h5>
    <p>Yuk Hubungi Customer Service Kami</p><br>
    <p>Customer service selalu siap sedia menyelesaikan permasalahanmu dan menjawab pertanyaan</p>
</div>

<div class="column">
    <h3>Hubungi Customer Service Sekarang</h3>
    <div class="cs">
        <a href=""target="blank">Whatsappp</a>
    </div><br><br>
    <div class="cs">
        <a href=""target="blank">Email<br></a>
    </div><br><br>
    <div class="cs">
        <a href=""target="blank">Instagram</a><br>
    </div>
</div>
</main>
