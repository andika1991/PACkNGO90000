...
<body>
    <h3 class="text-center mt-4 mb-5">Detail Pesanan Tiket Kapal</h3>
    <div class="container">
        <div class="row">
            <?php
            include 'koneksi.php';
            ...
            if(isset($_GET['id'])) {
                ...
                $id_pesanantiketkapal = $_GET['id'];
                
                // Buat kueri SQL untuk mendapatkan data tiket bus berdasarkan ID
                $query = "SELECT 
                            pb.invoice_id, 
                            jtb.pelabuhan_keberangkatan, 
                            jtb.pelabuhan_kedatangan, 
                            jtb.kelas, 
                            vb.nama_vendor, 
                            mp.nama_metode, 
                            pb.bukti_bayar, 
                            ...
                            dpb.nomor_kendaraan
                        FROM 
                            pesanantiketkapal pb 
                        JOIN 
                            jadwal_tiket_kapal jtb ON pb.id_jadwaltiketkapal = jtb.id_jadwaltiketkapal
                        JOIN 
                            vendor_kapal vb ON jtb.id_vendor = vb.id_vendor
                        JOIN 
                            metodepembayaran mp ON pb.id_metode = mp.id_metode 
                        JOIN 
                            pengguna uo ON pb.id_pengguna = uo.id_pengguna
                        JOIN
                            datapenumpangkapal dpb ON pb.id_datapenumpang = dpb.id_datapenumpang
                        WHERE
                            pb.id_pesanantiketkapal = $id_pesanantiketkapal";
                       ...
                       <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Terminal Keberangkatan:</strong> <?php echo $row["pelabuhan_keberangkatan"]; ?></p>
                                <p class="card-text"><strong>Terminal Kedatangan:</strong> <?php echo $row["pelabuhan_kedatangan"]; ?></p>
                                ...
                                <p class="card-text"><strong>Nomor Kendaraan:</strong> <?php echo $row["nomor_kendaraan"]; ?></p>
                            </div>
                        </div>
                    </div>
            <?php
